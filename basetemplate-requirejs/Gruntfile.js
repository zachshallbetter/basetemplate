...
module.exports = function(grunt)
{
    ...
    grunt.initConfig(
    {
        ...
        js_src_path         : 'assets/js',      // JS directory
        css_src_path        : 'assets/css',     // CSS directory
        images_src_path     : 'assets/images',  // Images directory

        block_file          : 'index.php',     // This is the path ( relative to src ) to where your javscript block is.
